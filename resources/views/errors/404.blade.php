...
<body>
    <main class="bl_page404">
        ...
        <p>Maaf! Halaman yang Anda cari tidak dapat ditemukan. Mungkin telah dihapus, namanya diubah, atau sementara
            tidak tersedia. Silakan periksa kembali URL atau kembali ke halaman utama kami.
        </p>
        <div class="bl_page404__wrapper">
            ...
            <a class="bl_page404__link" href="" onclick="window.history.back(); return false;">kembali</a>
        </div>
    </main>
</body>
